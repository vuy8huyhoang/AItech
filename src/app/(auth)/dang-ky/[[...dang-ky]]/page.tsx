    ...
    return (
        <div className="w-full flex justify-center items-center min-h-screen bg-gray-50 bg-gradient-to-r from-indigo-100 via-indigo-50 to-white dark:bg-gradient-to-r dark:from-gray-800 dark:via-gray-900 dark:to-black">
            <div className="flex flex-col lg:flex-row justify-center w-full max-w-7xl space-y-8 lg:space-y-0  rounded-2xl p-8">
                ...
                <div className="w-full sm:w-[80%] lg:w-[50%] max-w-md p-8 space-y-8 bg-white rounded-2xl lg:rounded-r-2xl shadow-2xl flex flex-col justify-center border border-gray-200">
                    <h1 className="text-3xl font-bold text-center text-gray-800">Xin chào mừng bạn</h1>
                    <p className="text-center text-gray-600 mb-4">Đăng ký tài khoản để sử dụng dịch vụ của chúng tôi</p>
